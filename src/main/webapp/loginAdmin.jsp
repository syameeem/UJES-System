...
<div class="centered">
	<form action="LoginAdmin.java" method="post">
	...
	<input style="width: 80%; font-size:16px;" type="password" name="passw" placeholder="Password" required>
	</div><br>
	
	<div><center>
	<a href="#"><button class="button button1">Login</button></a><br>
	</center>
	</div><br>
